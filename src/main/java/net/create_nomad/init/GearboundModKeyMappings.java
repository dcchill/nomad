...
public class GearboundModKeyMappings {
	public static final KeyMapping OPEN_BACKPACK = new KeyMapping("key.gearbound.open_backpack", GLFW.GLFW_KEY_B, "key.categories.gearbound") {
