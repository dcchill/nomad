...
public class CreateNomadModMenus {
	...
	public static final DeferredHolder<MenuType<?>, MenuType<ToolbeltMenu>> TOOLBELT_MENU = REGISTRY.register("toolbelt_menu", () -> IMenuTypeExtension.create((id, inventory, buffer) -> new ToolbeltMenu(id, inventory, inventory.player.getInventory().selected)));
