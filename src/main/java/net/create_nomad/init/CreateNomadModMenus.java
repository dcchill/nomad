...
public class CreateNomadModMenus {
	...
	public static final DeferredHolder<MenuType<?>, MenuType<FilingCabinetGuiMenu>> FILING_CABINET_GUI = REGISTRY.register("filing_cabinet_gui", () -> IMenuTypeExtension.create(FilingCabinetGuiMenu::new));
