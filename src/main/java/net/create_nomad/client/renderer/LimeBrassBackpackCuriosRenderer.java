...
public class LimeBrassBackpackCuriosRenderer implements ICurioRenderer {
	private static final ResourceLocation TEXTURE = ResourceLocation.parse("create_nomad:textures/entities/lime_backpack_e_texture.png");
	private final HumanoidModel humanoidModel;

	public LimeBrassBackpackCuriosRenderer() {
