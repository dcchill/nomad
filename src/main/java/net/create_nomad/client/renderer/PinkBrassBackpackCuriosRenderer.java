...
public class PinkBrassBackpackCuriosRenderer implements ICurioRenderer {
	private static final ResourceLocation TEXTURE = ResourceLocation.parse("create_nomad:textures/entities/pink_backpack_e_texture.png");
	private final HumanoidModel humanoidModel;

	public PinkBrassBackpackCuriosRenderer() {
