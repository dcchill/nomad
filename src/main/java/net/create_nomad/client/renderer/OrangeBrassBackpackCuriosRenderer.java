...
public class OrangeBrassBackpackCuriosRenderer implements ICurioRenderer {
	private static final ResourceLocation TEXTURE = ResourceLocation.parse("create_nomad:textures/entities/orange_backpack_e_texture.png");
	private final HumanoidModel humanoidModel;

	public OrangeBrassBackpackCuriosRenderer() {
