...
public class GrayBrassBackpackCuriosRenderer implements ICurioRenderer {
	private static final ResourceLocation TEXTURE = ResourceLocation.parse("create_nomad:textures/entities/gray_backpack_e_texture.png");
