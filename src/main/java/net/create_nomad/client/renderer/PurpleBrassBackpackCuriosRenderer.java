...
public class PurpleBrassBackpackCuriosRenderer implements ICurioRenderer {
	private static final ResourceLocation TEXTURE = ResourceLocation.parse("create_nomad:textures/entities/purple_backpack_e_texture.png");
	private final HumanoidModel humanoidModel;

	public PurpleBrassBackpackCuriosRenderer() {
