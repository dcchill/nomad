...
public class CyanBrassBackpackCuriosRenderer implements ICurioRenderer {
	private static final ResourceLocation TEXTURE = ResourceLocation.parse("create_nomad:textures/entities/cyan_backpack_e_texture.png");
	private final HumanoidModel humanoidModel;

	public CyanBrassBackpackCuriosRenderer() {
