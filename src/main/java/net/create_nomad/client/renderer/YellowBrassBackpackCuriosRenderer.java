...
public class YellowBrassBackpackCuriosRenderer implements ICurioRenderer {
	private static final ResourceLocation TEXTURE = ResourceLocation.parse("create_nomad:textures/entities/yellow_backpack_e_texture.png");
	private final HumanoidModel humanoidModel;

	public YellowBrassBackpackCuriosRenderer() {
