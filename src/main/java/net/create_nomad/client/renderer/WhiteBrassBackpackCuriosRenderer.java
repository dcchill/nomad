...
public class WhiteBrassBackpackCuriosRenderer implements ICurioRenderer {
	private static final ResourceLocation TEXTURE = ResourceLocation.parse("create_nomad:textures/entities/white_backpack_e_texture.png");
	private final HumanoidModel humanoidModel;

	public WhiteBrassBackpackCuriosRenderer() {
