...
public class RedBrassBackpackCuriosRenderer implements ICurioRenderer {
	private static final ResourceLocation TEXTURE = ResourceLocation.parse("create_nomad:textures/entities/red_backpack_e_texture.png");
	private final HumanoidModel humanoidModel;

	public RedBrassBackpackCuriosRenderer() {
