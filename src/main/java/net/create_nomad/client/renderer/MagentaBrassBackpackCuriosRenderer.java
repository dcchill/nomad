...
public class MagentaBrassBackpackCuriosRenderer implements ICurioRenderer {
	private static final ResourceLocation TEXTURE = ResourceLocation.parse("create_nomad:textures/entities/magenta_backpack_e_texture.png");
	private final HumanoidModel humanoidModel;

	public MagentaBrassBackpackCuriosRenderer() {
