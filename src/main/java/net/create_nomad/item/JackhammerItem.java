...
public class JackhammerItem extends PickaxeItem implements GeoItem {
	...
	public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
		...
		if (Screen.hasShiftDown()) {
			tooltip.add(Component.translatable("tooltip.gearbound.jackhammer.description_1").withStyle(ChatFormatting.WHITE));
			tooltip.add(Component.translatable("tooltip.gearbound.jackhammer.description_2").withStyle(ChatFormatting.GOLD));
		} else {
