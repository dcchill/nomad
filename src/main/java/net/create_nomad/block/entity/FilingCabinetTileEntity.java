...
public class FilingCabinetTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public FilingCabinetTileEntity(BlockPos pos, BlockState state) {
		super(CreateNomadModBlockEntities.FILING_CABINET.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(FilingCabinetBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<FilingCabinetTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<FilingCabinetTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("filing_cabinet");
	}
